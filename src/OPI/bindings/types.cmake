...
COMMENT("This type represents a Julian Day with microsecond accuracy")
BEGIN_STRUCTURE( JulianDay )
...
STRUCTURE_VARIABLE(JulianDay beginning_of_life)
COMMENT( "End of life" )
STRUCTURE_VARIABLE(JulianDay end_of_life)
COMMENT( "Epoch for which the object data is valid" )
STRUCTURE_VARIABLE(JulianDay current_epoch)
COMMENT( "Epoch at which the data for this object was created")
STRUCTURE_VARIABLE(JulianDay original_epoch)
COMMENT( "Epoch at the start of propagation")
STRUCTURE_VARIABLE(JulianDay initial_epoch)
END_STRUCTURE( Epoch )
...
BEGIN_ENUM(RecordType)
  ENUM_VALUE(REC_EPOCH 0)
  ENUM_VALUE(REC_POSITION 1)
  ENUM_VALUE(REC_VELOCITY 2)
  ENUM_VALUE(REC_ORBIT 3)
  ENUM_VALUE(REC_PROPERTIES 4)
  ENUM_VALUE(REC_ACCELERATION 5)
  ENUM_VALUE(REC_COVARIANCE 6)
  ENUM_VALUE(REC_POS_X 7)
  ENUM_VALUE(REC_POS_Y 8)
  ENUM_VALUE(REC_POS_Z 9)
  ENUM_VALUE(REC_VEL_X 10)
  ENUM_VALUE(REC_VEL_Y 11)
  ENUM_VALUE(REC_VEL_Z 12)
  ENUM_VALUE(REC_ORB_SMA 13)
  ENUM_VALUE(REC_ORB_ECC 14)
  ENUM_VALUE(REC_ORB_INC 15)
  ENUM_VALUE(REC_ORB_RAAN 16)
  ENUM_VALUE(REC_ORB_AOP 17)
  ENUM_VALUE(REC_ORB_MA 18)
  ENUM_VALUE(REC_PROP_MASS 19)
  ENUM_VALUE(REC_PROP_DIA 20)
  ENUM_VALUE(REC_PROP_A2M 21)
  ENUM_VALUE(REC_PROP_CD 22)
  ENUM_VALUE(REC_PROP_CR 23)
  ENUM_VALUE(REC_ACC_X 24)
  ENUM_VALUE(REC_ACC_Y 25)
  ENUM_VALUE(REC_ACC_Z 26)
  ENUM_VALUE(REC_COV_K1_K1 27)
  ENUM_VALUE(REC_COV_K2_K1 28)
  ENUM_VALUE(REC_COV_K2_K2 29)
  ENUM_VALUE(REC_COV_K3_K1 30)
  ENUM_VALUE(REC_COV_K3_K2 31)
  ENUM_VALUE(REC_COV_K3_K3 32)
  ENUM_VALUE(REC_COV_K4_K1 33)
  ENUM_VALUE(REC_COV_K4_K2 34)
  ENUM_VALUE(REC_COV_K4_K3 35)
  ENUM_VALUE(REC_COV_K4_K4 36)
  ENUM_VALUE(REC_COV_K5_K1 37)
  ENUM_VALUE(REC_COV_K5_K2 38)
  ENUM_VALUE(REC_COV_K5_K3 39)
  ENUM_VALUE(REC_COV_K5_K4 40)
  ENUM_VALUE(REC_COV_K5_K5 41)
  ENUM_VALUE(REC_COV_K6_K1 42)
  ENUM_VALUE(REC_COV_K6_K2 43)
  ENUM_VALUE(REC_COV_K6_K3 44)
  ENUM_VALUE(REC_COV_K6_K4 45)
  ENUM_VALUE(REC_COV_K6_K5 46)
  ENUM_VALUE(REC_COV_K6_K6 47)
  ENUM_VALUE(REC_COV_D1_K1 48)
  ENUM_VALUE(REC_COV_D1_K2 49)
  ENUM_VALUE(REC_COV_D1_K3 50)
  ENUM_VALUE(REC_COV_D1_K4 51)
  ENUM_VALUE(REC_COV_D1_K5 52)
  ENUM_VALUE(REC_COV_D1_K6 53)
  ENUM_VALUE(REC_COV_D1_D1 54)
  ENUM_VALUE(REC_COV_D2_K1 55)
  ENUM_VALUE(REC_COV_D2_K2 56)
  ENUM_VALUE(REC_COV_D2_K3 57)
  ENUM_VALUE(REC_COV_D2_K4 58)
  ENUM_VALUE(REC_COV_D2_K5 59)
  ENUM_VALUE(REC_COV_D2_K6 60)
  ENUM_VALUE(REC_COV_D2_D1 61)
  ENUM_VALUE(REC_COV_D2_D2 62)
END_ENUM(RecordType)
