...
file(APPEND ${OUTPUT_HEADER_FILE} "#ifdef __CUDACC__\n")
file(APPEND ${OUTPUT_HEADER_FILE} "#define ALIGN __align__(16)\n")
file(APPEND ${OUTPUT_HEADER_FILE} "#else\n")
file(APPEND ${OUTPUT_HEADER_FILE} "#ifdef __GNUC__\n")
file(APPEND ${OUTPUT_HEADER_FILE} "#define ALIGN __attribute__((aligned(16)))\n")
file(APPEND ${OUTPUT_HEADER_FILE} "#else\n")
file(APPEND ${OUTPUT_HEADER_FILE} "#ifdef _MSC_VER\n")
file(APPEND ${OUTPUT_HEADER_FILE} "#define ALIGN __declspec(align(16))\n")
...
file(APPEND ${OUTPUT_HEADER_FILE} "typedef struct ALIGN OPI_${TYPENAME}_t\n")
file(APPEND ${OUTPUT_HEADER_FILE} "{\n")
endmacro()
...
macro(PARSE_FUNCTION)
    ...
    file(APPEND ${OUTPUT_HEADER_FILE} "${FUNCTION_RETURN} ${FUNCTION_PREFIX}${FUNCTION_NAME}(${FUNCTION_BODY});\n")
    ...
    if(MAKE_STRINGWRAP)
    file(APPEND ${OUTPUT_HEADER_FILE} "${FUNCTION_RETURN} ${FUNCTION_PREFIX}${FUNCTION_NAME}StrLen(${FUNCTION_BODY_WRAP});\n")
...
macro(CHANGE_COMMAND NEW_COMMAND)
  if("${COMMAND}" STREQUAL "CONSTRUCTOR")
    ...
    file(APPEND ${OUTPUT_HEADER_FILE} "OPI_${CLASS_NAME} ${CONSTRUCTOR_NAME}(${FUNCTION_BODY});\n")
  ...
  elseif("${COMMAND}" STREQUAL "DESTRUCTOR")
    ...
    file(APPEND ${OUTPUT_HEADER_FILE} "void ${CONSTRUCTOR_NAME}(OPI_${CLASS_NAME} obj);\n")
