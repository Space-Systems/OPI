...
file(APPEND ${OUTPUT_FILE} "#ifdef __CUDACC__\n")
file(APPEND ${OUTPUT_FILE} "#define ALIGN __align__(16)\n")
file(APPEND ${OUTPUT_FILE} "#else\n")
file(APPEND ${OUTPUT_FILE} "#ifdef __GNUC__\n")
file(APPEND ${OUTPUT_FILE} "#define ALIGN __attribute__((aligned(16)))\n")
file(APPEND ${OUTPUT_FILE} "#else\n")
file(APPEND ${OUTPUT_FILE} "#ifdef _MSC_VER\n")
file(APPEND ${OUTPUT_FILE} "#define ALIGN __declspec(align(16))\n")
...
file(APPEND ${OUTPUT_FILE} "\tstruct OPI_API_EXPORT ALIGN ${TYPENAME}\n")
file(APPEND ${OUTPUT_FILE} "\t{\n")
endmacro()
